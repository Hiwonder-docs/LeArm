...
### 14.1.2.2 Structural Parameters

<img src="../_static/media/chapter_14/section_1/media/image2.png" class="common_img" />

### 14.1.2.3 Physical Characteristics

<img src="../_static/media/chapter_14/section_1/media/image3.png" class="common_img" />

### 14.1.3 Learning Guide

You can follow the steps below to learn how the tank chassis operates and how it integrates with the LeArm robotic arm:

| **Path** | **Description** |
| :--: | :--: |
| [14. LeArm + Tank Chassis Course->14.1 Introduction to Tank Chassis and installation->14.1.4 Tank Chassis Installation]() | Learn how to assemble the chassis from separate components, mount the robotic arm onto the chassis, and complete the wiring process. |
| [14. LeArm + Tank Chassis Course->14.2 Wireless Controller]() | Learn how to use a PS2 controller to operate the robotic arm and Mecanum chassis. |
| [14. LeArm + Tank Chassis Course Course->14.3 APP Control]() | Learn how to use the APP to operate the robotic arm and Mecanum chassis. |
| [14. LeArm + Tank Chassis Course->14.4 Tank Chassis Kinematics Analysis]() | Study the kinematic modeling and parameter derivation for the tank chassis. |

### 14.1.4 Tank Chassis Installation

This section is only for users who purchased the LeArm + tracked chassis kit (disassembled version).
...
[2. Remote Control -> 2.2 App Control]() and are familiar with the function icons in the app interface.
